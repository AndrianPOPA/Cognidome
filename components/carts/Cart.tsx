            ...
            <SheetDescription className="flex items-start justify-between gap-4 flex-col h-[90vh]">
              <div className="overflow-y-auto">
                ...
                {cartItems.map((item) => (
                  <div
                    key={item.id}
                    className="flex items-center justify-start gap-4 p-4 mt-2 border-b-2 border-t-gray-500"
                  >
                    <Image
                    ...
                    <div className="space-y-3 w-full">
                      ...
                      <div className="flex items-center justify-between gap-4">
                        <p className="text-lg border border-green-500 px-3 py-1 rounded-md text-green-500 min-w-[80px] text-center">
