...
const BannerOne = () => {
  ...
  return (
    <section className="relative w-full bg-gradient-to-r from-blue-50 to-indigo-100 dark:from-blue-900 dark:to-indigo-900 py-4">
      <div className="max-w-screen-xl mx-auto px-4 md:px-8 flex flex-col-reverse lg:flex-row items-center justify-between">
        <div className="flex flex-col justify-center items-center text-center lg:text-left lg:w-1/2">
          <h2 className="text-3xl lg:text-5xl text-center font-bold text-blue-400 mt-4 leading-tight">
        ...
        <div className="relative lg:w-1/2  lg:mt-0">
          <div className="rounded-xl overflow-hidden relative w-[20rem] lg:w-[30rem] h-[15rem] lg:h-[25rem] ">
            <Image src="/images/banner/61KJEDAGhaL_imgupscaler.ai_General_2K-Photoroom.png" className="object-contain" fill alt="Electronics Banner"/>
          </div>
